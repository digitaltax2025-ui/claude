...
/**
 * לפי מדיניות האפיון (docs/agent-brief.md, סעיף "טבלאות מתעדכנות"): ערך
 * ייבחר לפי תאריך והקשר, בלי ברירת מחדל שקטה מהשנה האחרונה. קבוע זה
 * מסמן במפורש שהטבלה הנוכחית *היא* ברירת מחדל שקטה כזו, ולכן אסור
 * להציג תוצאה המבוססת עליה כאילו אומתה.
 */
export const SOURCE_VERIFIED = false;
