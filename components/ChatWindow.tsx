...
const SUGGESTIONS = [
  "לקוח קיבל שכר מילואים, דמי אבטלה והכנסה מעסק באותה שנת מס — מה סדר הבדיקה?",
  "מהו הדין בעניין חלף הודעה מוקדמת שניתן ללא טופס 161, לצורך סיווג לפטור ממס?",
  "לקוחה עצמאית שיצאה לחופשת לידה — מה תנאי הזכאות לתקופת אכשרה, ומה חסר לי כדי להשיב?",
  "יש שני מסמכים סותרים לגבי מועד ניתוק יחסי עובד-מעביד — איך להציג את הסתירה?",
  "לקוח קיבל דרישת הצהרת הון אחרי סגירת עסק — מה ההליך ומה אפשר לבקש?",
];
        ...
        {messages.length === 0 && (
          <div className="text-center text-slate-500 mt-8 space-y-4">
            <p className="text-lg font-medium text-slate-700">
              עוזר מחקר וניתוח למיסוי היחיד ולשכר. פתח בתיאור השאלה או התיק.
            </p>
